      ...
      <div className="max-w-[1200px] mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between md:items-start gap-10">
          <div className="mb-8 md:mb-0">
            <h4 className="font-bold text-2xl mb-1">Paylink</h4>
            <div className="text-[#B9C3CE] text-sm mb-3">
              Ready to integrate Paylink?
            </div>
            <div className="flex flex-col sm:flex-row gap-3 mb-3">
              <a
                href="#"
                className="inline-block px-4 py-2 bg-[#2563eb] text-white rounded-[6px] text-sm font-semibold hover:bg-[#174ea6] transition"
              >
                Get Started
              </a>
              <a
                href="#"
                className="inline-block px-4 py-2 bg-white text-[#2563eb] border border-[#2563eb] rounded-[6px] text-sm font-semibold hover:bg-gray-100 transition"
              >
                Contact Sales
              </a>
            </div>
            <div className="text-[#B9C3CE] text-xs">
              &copy; {new Date().getFullYear()} Paylink. All rights reserved.
            </div>
          </div>
        ...
        <div className="mt-10 border-t border-[#384962] pt-5 flex flex-col md:flex-row justify-between items-center gap-3 text-[#B9C3CE] text-xs">
          <div>
            <a href="#" className="hover:text-white mr-4">Terms &amp; Conditions</a>
